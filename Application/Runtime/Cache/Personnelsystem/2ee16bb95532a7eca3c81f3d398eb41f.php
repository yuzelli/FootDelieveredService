            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>订单详情 <a href="/Plum/1/Personnelsystem/Department/listsedit" style="margin-left:15px; color:#06cbc4">订单列表</a></h5>
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/Plum/1/Personnelsystem/Department/UpdateAction/order_id/<?php echo ($rs_order["order_id"]); ?>" class="form-horizontal" id="form-admin-add" >
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <span class="form-control"><?php echo ($rs_order["username"]); ?></span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <img src="/Plum/1/<?php echo ($rs_order["img_url"]); ?>" width="100" height="100">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    <a style="margin-left: 15px;" href="/Plum/1/Personnelsystem/Department/RemindOrder/order_id/<?php echo ($rs_order["order_id"]); ?>">摧单
                                        </a>
                                </div>
                            </div>
                        </form>
