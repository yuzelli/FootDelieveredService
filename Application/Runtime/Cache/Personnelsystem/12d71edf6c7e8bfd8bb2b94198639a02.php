...
<head>
    ...
    <!-- Data Tables -->
    <link href="/Plum/1/Public/Theme1/css/plugins/dataTables/dataTables.bootstrap.css" rel="stylesheet">
...
<body class="gray-bg">
            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>员工列表 <a href="/Plum/1/Personnelsystem/Staff/add" style="margin-left:15px; color:#06cbc4">添加员工</a></h5>
                    ...
                    <form method="post" action="/Plum/1/Personnelsystem/Staff/DelAll" class="form-horizontal" id="form-admin-add">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <!-- <th class="dropdown hidden-xs">所在部门</th>
                            ...
                            <tbody>
                                ...
                                <td><a href="/Plum/1/Personnelsystem/Staff/show/stId/<?php echo ($val_staffLists["stId"]); ?>"><?php echo ($val_staffLists["stName"]); ?></a>
                                </td>
                                ...
                                <?php if($stPhoto < 10): ?><td class="dropdown hidden-xs"><img src="/Plum/1/Public/Theme1/img/not.png" width="100px" height="110px"></td>
                                <?php else: ?>
                                <td class="dropdown hidden-xs"><a href="/Plum/1/Personnelsystem/Staff/showimages/stId/<?php echo ($val_staffLists["stId"]); ?>">
                                <img src="/Plum/1/<?php echo ($val_staffLists["stPhoto"]); ?>" width="100px" height="110px">
                                </a>
                                </td><?php endif; ?> -->
                                ...
                                <td class="dropdown hidden-xs"><a href="/Plum/1/Personnelsystem/Staff/showfujian/stId/<?php echo ($val_staffLists["stId"]); ?>">查看</a></td>
                                <?php elseif($resname == 2): ?>
                                <td class="dropdown hidden-xs"><a href="/Plum/1/<?php echo ($val_staffLists["stEnclosure"]); ?>">下载</a></td><?php endif; ?> -->
                                ...
                                <a title="设置离职员工" href="/Plum/1/Personnelsystem/Staff/quitadd/stId/<?php echo ($val_staffLists["stId"]); ?>"><i class="glyphicon glyphicon-minus" style="margin-right: 10px;"></i></a>
                                
                                <a title="编辑员工资料" href="/Plum/1/Personnelsystem/Staff/update/stId/<?php echo ($val_staffLists["stId"]); ?>/depId/<?php echo ($depId); ?>"><i class="glyphicon glyphicon-pencil" style="margin-right: 10px;"></i></a>
                                
                                <a title="删除" href="/Plum/1/Personnelsystem/Staff/DelAction/stId/<?php echo ($val_staffLists["stId"]); ?>" ><i class="glyphicon glyphicon-remove"></i></a>
    ...
    <script src="/Plum/1/Public/Theme1/js/plugins/jeditable/jquery.jeditable.js"></script>
    <script src="/Plum/1/Public/Theme1/js/plugins/dataTables/jquery.dataTables.js"></script>
    <script src="/Plum/1/Public/Theme1/js/plugins/dataTables/dataTables.bootstrap.js"></script>
