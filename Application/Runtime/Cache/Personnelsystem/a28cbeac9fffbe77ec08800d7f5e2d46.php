            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>添加员工信息 <a href="/Plum/1/Personnelsystem/Staff/lists" style="margin-left:15px; color:#06cbc4">员工列表</a></h5>
                        <div class="ibox-tools">
                            
                        </div>
                    </div>
                    <div class="ibox-content">
                        <form method="post" action="/Plum/1/Personnelsystem/Staff/AddAction" class="form-horizontal" id="form-admin-add" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input type="text" name="stMultiracial" id="stMultiracial" class="form-control">
                                </div>
